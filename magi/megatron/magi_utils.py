...
def add_magi_args(parser):
    ...
    group.add_argument("--magi-schedule-interval", type=int, default=10, help="schedule interval, setting 0 to enable dynamic schedule interval")
    ...
    group.add_argument("--janus", action="store_true", help="simulate janus")
